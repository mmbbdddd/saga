...
public class ChaosRule {
    ...
    public ChaosRule(ChaosTargetType target, String expression, String errorMessage, double probability, List<Class<? extends Throwable>> errorTypes) {
        this.target       = target;
    ...
    public boolean match(ChaosTargetType target, Object proxy, Method method, Object[] args) {
